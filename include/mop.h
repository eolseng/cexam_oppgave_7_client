 ...
 * All messages are acknowledged when received, including header transfers
 ...
 *  * Server responds with ACCEPT if it can handle the connection or DECLINE if it can't
 ...
 *  * DH MUST contain the size of the string (DH.Bytes > 0)
 *
